...
[![PyPI](https://img.shields.io/pypi/v/cognis-corsaudit.svg)](https://pypi.org/project/cognis-corsaudit/)
[![CI](https://github.com/cognis-digital/corsaudit/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/corsaudit/actions)
...
CORSAUDIT exists for one job — detect permissive/misconfigured cors from headers or a config — and does it without a SaaS bill or heavyweight setup.
...
```bash
corsaudit --version
corsaudit scan .                      # scan the current project
corsaudit scan . --format json
corsaudit scan . --fail-on high       # non-zero exit for CI gates
corsaudit mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **CORScanner**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`corsaudit` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
