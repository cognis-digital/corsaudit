"""CORSAUDIT core — Detect permissive/misconfigured CORS from headers or a config."""
...
RULES = [
    ("COR-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("COR-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("COR-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
