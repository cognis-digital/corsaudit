#!/usr/bin/env sh
# Universal installer for corsaudit. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/corsaudit.git"
echo "Installing corsaudit ..."
